...
urlpatterns = [
    ...
    url(r'^clases/aerobicos/11$', ClasesInterior2View.as_view(), name='clases-interior2'),
    url(r'^clases/aerobicos/12$', ClasesInterior2View.as_view(), name='clases-interior2'),
    url(r'^clases/aerobicos/13$', ClasesInterior2View.as_view(), name='clases-interior2'),
    url(r'^clases/aerobicos/14$', ClasesInterior2View.as_view(), name='clases-interior2'),
    url(r'^clases/aerobicos/15$', ClasesInterior2View.as_view(), name='clases-interior2'),
    url(r'^clases/aerobicos/16$', ClasesInterior2View.as_view(), name='clases-interior2'),
    url(r'^clases/aerobicos/17$', ClasesInterior2View.as_view(), name='clases-interior2'),
    url(r'^clases/aerobicos/18$', ClasesInterior2View.as_view(), name='clases-interior2'),
